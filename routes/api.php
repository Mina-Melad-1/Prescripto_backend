...
Route::put('/editProfile', [AuthController::class, 'edit_profile'])->middleware('auth:sanctum');
...
Route::put('/admin/edit-doctor/{doctorId}', [AdminController::class, 'edit_doctor'])->middleware('auth:sanctum', 'admin');
